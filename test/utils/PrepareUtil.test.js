...
describe( 'PrepareUtil', function ()
{
        ...
        describe( 'methods', function ()
        {
                ...
                it( '#preparePeerId : load from an existing file', async () =>
                {
                        ...
                        //
                        //      console.doctor( `loadedStoragePeerId :`, loadedStoragePeerId );
                        //      loadedStoragePeerId : {
                ...
                it( '#prepareSwarmKey : load from an existing file', async () =>
                {
                        ...
                        try
                        {
                                ...
                                //console.doctor( '#prepareSwarmKey successfully write swarmKey to file :', uniqueSwarmKeyTmpFullPath );
                        }
                        catch ( err )
                        {
                        ...
                        //console.doctor( `loadedSwarmKeyObj :`, loadedSwarmKeyObj );
                        //      loadedSwarmKeyObj : {
