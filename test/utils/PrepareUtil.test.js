...
describe( 'PrepareUtil', function ()
{
        ...
        describe( 'methods', function ()
        {
                ...
                it( '#preparePeerId : load from an existing file', async () =>
                {
                        ...
                        //
                        //      console.log( `loadedStoragePeerId :`, loadedStoragePeerId );
                        //      loadedStoragePeerId : {
                ...
                it( '#prepareSwarmKey : load from an existing file', async () =>
                {
                        ...
                        try
                        {
                                ...
                                //console.log( '#prepareSwarmKey successfully write swarmKey to file :', uniqueSwarmKeyTmpFullPath );
                        }
                        catch ( err )
                        {
                        ...
                        //console.log( `loadedSwarmKeyObj :`, loadedSwarmKeyObj );
                        //      loadedSwarmKeyObj : {
